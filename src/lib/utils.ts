...
// 채널별 유입경로(서브소스) 프리셋 — 파이프라인 + 광고성과 공통
export const CHANNEL_SUB_SOURCES: Record<string, string[]> = {
  '네이버': ['검색광고', '블로그광고', '배너광고', '기타'],
  '구글': ['검색광고', 'GDN', '기타'],
  '메타': ['페이스북', '인스타그램', '기타'],
  '유튜브': ['광고', '오가닉', '기타'],
  '검색유입': ['네이버', '구글', '생성형AI', '기타'],
  '자사채널': ['홈페이지', '깃북', '해피톡', '대표전화', '개인전화', '기타'],
  '블로그': ['네이버', '티스토리', '아이콘', '팀부스터', '기타'],
  '언론': ['보도자료', '기사', '기타'],
  '대표전화': ['대표전화'],
  '개인전화': ['개인전화'],
  '추천': ['기존고객', '파트너사', '기타'],
  '이벤트/행사': ['박람회', '세미나', '웨비나', '기타'],
}

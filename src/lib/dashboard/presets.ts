...
export const DASHBOARD_PRESETS: RolePreset[] = [
  ...
  },
  {
    ...
    widgetIds: [
      ...
      { id: 'weekly_tasks',     x: 0, y: 2, w: 12, h: 3 },
      { id: 'overdue_actions',  x: 0, y: 5, w: 6, h: 3 },
      { id: 'pre_conversion',   x: 6, y: 5, w: 6, h: 3 },
      { id: 'pipeline_funnel',  x: 0, y: 8, w: 12, h: 3 },
    ],
  },
  {
    roleKey: 'support',
    ...
    widgetIds: [
      ...
      { id: 'weekly_tasks',         x: 0, y: 2, w: 12, h: 3 },
      { id: 'expiring_contracts',   x: 0, y: 5, w: 12, h: 4 },
    ],
  },
  {
    roleKey: 'hardware',
